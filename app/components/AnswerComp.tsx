...
function AnswerComp({ answer, submitAnswer }: AnswerCompProps) {
  return (
    <button
      ...
      className={cn(
        "bg-white w-full h-14 rounded-lg group relative hover:text-white active:text-white hover:bg-compliment active:bg-compliment flex items-center pl-3 gap-x-3",
        answer.answer === "Yes" &&
